// Translations for Caminos Ganadera website
const translations = {
    es: {
        // Header
        contact: "Contacto",
        ...
        hero_discover_potential: "Descubra la potencialidad de Formosa.",
        hero_company_location: "Caminos Ganadera, Formosa",
        hero_country: "ARGENTINA",
        ...
        // Production Section
        production_activities: "Actividades Productivas",
        cattle_breeding: "Cría ganadera",
        cattle_fattening: "Engorde de ganado",
        agricultural_production: "Producción agrícola",
        mixed_farming: "Agricultura mixta",
        production_capacity: "Capacidad Productiva",
        production_description: "Esta estancia cuenta con capacidad para desarrollar actividades ganaderas y agrícolas de manera integrada, aprovechando las {surface} hectáreas disponibles para maximizar la producción y rentabilidad.",
        
        // Infrastructure Section
        infrastructure_features: "Características de Infraestructura",
        main_house: "Casa principal",
        corrals: "Corrales de trabajo",
        water_systems: "Sistemas de agua",
        access_roads: "Caminos de acceso",
        infrastructure_quality: "Calidad de Infraestructura",
        ...
        institutional_description: "Descripción Institucional",
        ...
        multiple_access: "Accesos desde múltiples puntos",
        centralized_infrastructure: "Infraestructura centralizada",
        ...
        contact_message: "Contáctanos para más información sobre esta estancia",
        send: "Enviar",
        ...
        // Estancia specific
        hectares: "hectáreas",
        hectares_in_formosa: "hectáreas en Formosa",
        is_an_estancia: "es una estancia ubicada en Formosa, Argentina.",
        hectares_dedicated_to: "hectáreas dedicadas a",
        interested_in_estancia: "¿Interesado en {estancia}?",
        contact_for_info: "Contáctanos para más información sobre esta estancia",
        name_field: "Nombre",
        surname_field: "Apellido",
        email_field: "Email",
        phone_field: "Teléfono",
        message_field: "Mensaje sobre {estancia}...",
        send_button: "Enviar",
        contact_info_title: "Información de Contacto",
        productivity_scale_footer: "Productividad, escala y visión territorial en el corazón de Formosa, Argentina.",
        estancias_footer: "Estancias",
        all_rights_reserved: "Todos los derechos reservados.",
        
        // Homepage
        know_estancias: "Conocer Estancias",
        about_ganadera: "Sobre Ganadera",
        about_ganadera_desc1: "Ganadera es un conjunto de estancias estratégicamente ubicadas en la provincia de Formosa, Argentina, dedicadas a la producción ganadera, agrícola y forestal. Abarcando más de 50.000 hectáreas operativas, este proyecto territorial integra infraestructura de alto nivel, diversidad de suelos, acceso logístico privilegiado y un enfoque moderno de gestión del campo.",
        about_ganadera_desc2: "El grupo está compuesto por 10 chacras (estancias), cada una con identidad propia pero bajo un mismo estándar operativo. Ganadera no es solo una agrupación de tierras, sino una visión agroproductiva en escala, que permite adaptabilidad a distintos tipos de inversión, proyectos productivos y expansión modular.",
        hectares: "Hectáreas",
        estates: "Estancias",
        ...
        developed_infrastructure: "🔹 Infraestructura desarrollada y funcional",
        developed_infrastructure_title: "Infraestructura Desarrollada",
        developed_infrastructure_desc: "Más de 100 km de caminos internos, viviendas para personal, galpones, corrales, instalaciones operativas.",
        strategic_location: "🔹 Ubicación estratégica",
        strategic_location_title: "Ubicación Estratégica",
        ...
        long_term_vision_title: "Visión de Largo Plazo",
        ...
        multimedia_items: [
            "Galería fotográfica aérea y por estancia",
            "Mapas operativos con planos reales", 
            "Videos institucionales de campo",
            "Acceso a fichas en formato descargable"
        ],
        why_invest: "🧭 ¿Por qué invertir en Caminos Ganadera?",
        investment_points: [
            "Escala operativa real, lista para producción",
            "Diversificación de usos y rotación de cultivos",
            "Infraestructura funcional ya instalada",
            "Accesos logísticos pavimentados",
            "Recursos naturales en abundancia",
            "Potencial de crecimiento y subdivisión"
        ],
        ...
        rainfall_regime: "RÉGIMEN DE LLUVIAS: 700 mm a 1,200 mm x año",
        ...
        infrastructure_text2: "La mayoria de las estancias están sobre pavimento con acceso a internet via local providers and Starlink. Oficina central en Formosa en una de las estancias (El Yarara) y Estudio Contable en Buenos Aires. Tres cascos \"patronales\" importantes con muy buenas construcciones, cascos y parques.",
        infrastructure_detailed: "Extensa caminería interna en cada campo, múltiples molinos, perforaciones, represas, aguadas y apotreramiento en muy buen estado en todos los campos. Excelentes instalaciones Ganaderas en perfecto funcionamiento en cada establecimiento. Potencial para agricultura de diferente extensión en cada campo. Muy buenas viviendas y puestos para personal.",
    ...
    en: {
        ...
        hero_subtitle_new: "CAMINOS GANADERA",
        hero_discover_potential: "Discover the potential of Formosa.",
        hero_company_location: "Caminos Ganadera, Formosa",
        hero_country: "ARGENTINA",
        ...
        cattle_fattening: "Cattle fattening",
        agricultural_production: "Agricultural production",
        mixed_farming: "Mixed farming",
        production_capacity: "Production Capacity",
        production_description: "This estate has the capacity to develop livestock and agricultural activities in an integrated manner, taking advantage of the {surface} hectares available to maximize production and profitability.",
        
        // Infrastructure Section
        infrastructure_features: "Infrastructure Features",
        main_house: "Main house",
        corrals: "Working corrals",
        ...
        location: "Location",
        main_use: "Main use",
        institutional_description: "Institutional Description",
        ...
        multiple_access: "Access from multiple points",
        centralized_infrastructure: "Centralized infrastructure",
        ...
        contact_message: "Contact us for more information about this estate",
        send: "Send",
        ...
        // Estancia specific
        hectares: "hectares",
        hectares_in_formosa: "hectares in Formosa",
        is_an_estancia: "is an estate located in Formosa, Argentina.",
        hectares_dedicated_to: "hectares dedicated to",
        interested_in_estancia: "Interested in {estancia}?",
        contact_for_info: "Contact us for more information about this estate",
        name_field: "Name",
        surname_field: "Surname",
        email_field: "Email",
        phone_field: "Phone",
        message_field: "Message about {estancia}...",
        send_button: "Send",
        contact_info_title: "Contact Information",
        productivity_scale_footer: "Productivity, scale and territorial vision in the heart of Formosa, Argentina.",
        estancias_footer: "Estates",
        all_rights_reserved: "All rights reserved.",
        
        // Homepage
        know_estancias: "Know Estates",
        about_ganadera: "About Ganadera",
        about_ganadera_desc1: "Ganadera is a set of strategically located estates in the province of Formosa, Argentina, dedicated to livestock, agricultural and forestry production. Covering more than 50,000 operational hectares, this territorial project integrates high-level infrastructure, soil diversity, privileged logistical access and a modern approach to field management.",
        about_ganadera_desc2: "The group is made up of 10 farms (estates), each with its own identity but under the same operational standard. Ganadera is not just a grouping of lands, but a scalable agroproductive vision that allows adaptability to different types of investment, productive projects and modular expansion.",
        hectares: "Hectares",
        estates: "Estates",
        ...
        developed_infrastructure: "🔹 Developed and functional infrastructure",
        developed_infrastructure_title: "Developed Infrastructure",
        developed_infrastructure_desc: "More than 100 km of internal roads, staff housing, sheds, corrals, operational facilities.",
        strategic_location: "🔹 Strategic location",
        strategic_location_title: "Strategic Location",
        ...
        multimedia_items: [
            "Aerial and per-estate photographic gallery",
            "Operational maps with real plans",
            "Institutional field videos",
            "Access to downloadable format files"
        ],
        why_invest: "🧭 Why invest in Caminos Ganadera?",
        investment_points: [
            "Real operational scale, ready for production",
            "Diversification of uses and crop rotation",
            "Functional infrastructure already installed",
            "Paved logistics access",
            "Abundant natural resources",
            "Growth and subdivision potential"
        ],
        ...
        main_description: "PRODUCERS OF THE BEST BRAFORD, BRANGUS, AND BRAHMÁ BREEDS RAISED IN THE NORTH OF ARGENTINA AND IN THE SUBTROPICAL PROVINCE OF FORMOSA.",
        about_text: "Caminos Ganadera is an agricultural and cattle complex of over 43,000 hectares (or 106,247 acres), consisting of more than 10 contiguous estancias, with its local management and administration headquarters currently at Estancia Yarara. Formosa. All are located in the north-central part of Formosa, in the Patiño department. It is an extraordinarily productive cattle area due to its subtropical climate with very short and mild winters. Our animals are known for fetching the best prices in Northern Argentina at fairs and auctions.",
        ...
        rainfall_regime: "RAINFALL REGIME: 700 mm to 1,200 mm annually",
        ...
        infrastructure_text2: "Most of the estancias are on pavement with internet access via local providers and Starlink. Central office in Formosa at one of the estancias (El Yarara) and Accounting offices in Buenos Aires. Three significant \"patronal\" estates with very good buildings, estates and parks.",
        infrastructure_detailed: "Extensa caminería interna en cada campo, múltiplos moinhos, perfurações, represas, aguadas e apotreramiento em muito bom estado em todos os campos. Excelentes instalações Ganaderas em perfeito funcionamento em cada estabelecimento. Potencial para agricultura de diferente extensão em cada campo. Muito boas moradias e postos para pessoal.",
        estancias_title: "Estancias:",
        estancias_header: "Our Estancias",
        estancias_no_link: "No file available",
        videos_title: "ESTATE VIDEOS",
        videos_description: "Discover our estates through videos that show daily activities, livestock, facilities and the natural beauty of each property.",
        estancias_list: [
    ...
    pt: {
        ...
        hero_subtitle_new: "CAMINOS GANADERA",
        hero_discover_potential: "Descubra o potencial de Formosa.",
        hero_company_location: "Caminos Ganadera, Formosa",
        hero_country: "ARGENTINA",
        ...
        productivity_scale_footer: "Produtividade, escala e visão territorial no coração de Formosa, Argentina.",
        estancias_footer: "Propriedades",
        all_rights_reserved: "Todos os direitos reservados.",
        
        // Homepage
        know_estancias: "Conhecer Propriedades",
        about_ganadera: "Sobre Ganadera",
        about_ganadera_desc1: "Ganadera é um conjunto de propriedades estrategicamente localizadas na província de Formosa, Argentina, dedicadas à produção pecuária, agrícola e florestal. Abrangendo mais de 50.000 hectares operacionais, este projeto territorial integra infraestrutura de alto nível, diversidade de solos, acesso logístico privilegiado e uma abordagem moderna de gestão do campo.",
        about_ganadera_desc2: "O grupo é composto por 10 chacras (propriedades), cada uma com identidade própria mas sob um mesmo padrão operacional. Ganadera não é apenas um agrupamento de terras, mas uma visão agroprodutiva em escala, que permite adaptabilidade a diferentes tipos de investimento, projetos produtivos e expansão modular.",
        hectares: "Hectares",
        estates: "Propriedades",
        km_roads: "Km de estradas",
        operational: "Operacional",
        our_proposal: "Nossa proposta",
        mixed_production: "🔹 Produção mista de alto rendimento",
        mixed_production_title: "Produção Mista",
        mixed_production_desc: "Ciclo pecuário completo (cria, recria e engorda), com integração agrícola para autossustento ou comercialização direta.",
        developed_infrastructure: "🔹 Infraestrutura desenvolvida e funcional",
        developed_infrastructure_title: "Infraestrutura Desenvolvida",
        developed_infrastructure_desc: "Mais de 100 km de estradas internas, moradias para pessoal, galpões, currais, instalações operacionais.",
        strategic_location: "🔹 Localização estratégica",
        strategic_location_title: "Localização Estratégica",
        strategic_location_desc: "Frente à Ruta Nacional 86 e à Ruta Provincial 23, com acesso imediato a povoados próximos.",
        long_term_vision: "🔹 Visão de longo prazo",
        long_term_vision_desc: "Caminos Ganadera foi pensada como uma plataforma territorial modular, com possibilidades de expansão, subdivisão operacional ou exploração unificada. Ideal para fundos de investimento, produtores, empresas do agronegócio e esquemas associativos.",
        estancias_comprising: "As propriedades que conformam Caminos Ganadera",
        click_each: "Clique em cada uma para acessar sua ficha completa, mapa, fotos e descrição detalhada:",
        multimedia_visualization: "📸 Multimídia e visualização",
        multimedia_items: [
            "Galeria fotográfica aérea e por propriedade",
            "Mapas operacionais com planos reais",
            "Vídeos institucionais de campo",
            "Acesso a fichas em formato descarregável"
        ],
        why_invest: "🧭 Por que investir em Caminos Ganadera?",
        investment_points: [
            "Escala operacional real, pronta para produção",
            "Diversificação de usos e rotação de cultivos",
            "Infraestrutura funcional já instalada",
            "Acessos logísticos pavimentados",
            "Recursos naturais em abundância",
            "Potencial de crescimento e subdivisão"
        ],
        contact_section: "📩 Contato",
        contact_questions: [
            "Quer mais informações?",
            "Está interessado em uma das chacras?",
            "Gostaria de conhecer o projeto de forma presencial?"
        ],
        contact_description: "Entre em contato e um de nossos especialistas agrocomerciais te brindará assessoramento completo, fichas técnicas, localização satelital e condições de operação.",
        ...
        about_text: "Caminos Ganadera é um complexo agrícola e pecuário de mais de 43.000 hectares (ou 106.247 acres), consistindo em mais de 10 propriedades contíguas, com sua sede de gestão e administração local atualmente na Estância Yarara. Formosa. Todas estão localizadas na parte centro-norte de Formosa, no departamento Patiño. É uma área pecuária extraordinariamente produtiva devido ao seu clima subtropical com invernos muito curtos e suaves. Nossos animais são conhecidos por obter os melhores preços no Norte da Argentina em feiras e leilões.",
        ...
        rainfall_regime: "REGIME DE CHUVAS: 700 mm a 1.200 mm por ano",
        ...
        videos_title: "VÍDEOS DAS PROPRIEDADES",
...
function updatePageContent() {
    ...
    document.querySelectorAll('[data-translate-placeholder]').forEach(element => {
        ...
        const params = JSON.parse(element.getAttribute('data-translate-params') || '{}');
        element.placeholder = getText(key, params);
    });
}
